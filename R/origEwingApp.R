...
origEwingApp <- function(title = "Population Ethology") {
  ui <- shiny::fluidPage(
    shiny::titlePanel(title),
    shiny::sidebarLayout(
      shiny::sidebarPanel(
        origEwingInput("ewing")
      ),
      shiny::mainPanel(
        origEwingOutput("ewing")
      )))
  
  server <- function(input, output, server) {
    origEwingServer("ewing")
  }
