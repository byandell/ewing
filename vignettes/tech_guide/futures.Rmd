---
title: "Leftist-Tree Queue & Development Tracker"
author: "Brian S. Yandell"
date: "`r format(Sys.time(), '%d %B %Y')`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Leftist-Tree Queue & Development Tracker}
...
- **Organism Movement on Hex Grid (`hexmoveApp`)**:
  ...
  - Created `hexmoveApp` launcher script ([`inst/scripts/hexmoveApp.R`](../../inst/scripts/hexmoveApp.R)) and Quarto demo ([`demos/hexmoveApp.qmd`](../../demos/hexmoveApp.qmd)).

- **Systems Ethology Platform Refactor (`sysetholApp` & `ewingApp`)**:
  - Exported [`R/sysetholApp.R`](../../R/sysetholApp.R) (`sysetholApp`, `sysetholInput`, `sysetholOutput`, `sysetholServer`).
  ...
  - Simplified [`R/ewingApp.R`](../../R/ewingApp.R) to compose UI/server directly from `sysetholApp` components + `downloadApp`.
  - Embedded serverless WebAssembly Shinylive block into [`demos/sysetholApp.qmd`](../../demos/sysetholApp.qmd).
...
- **Dist Plots Aesthetics & Continuous Stepping History**:
  ...
  - Fixed `setEvents()` in [`R/Events.R`](../../R/Events.R) so empty life stage vectors do not truncate the `community` object.
