...
- **[refactor.md](refactor.md)**: Architectural notes and workflows relating to deeper legacy code restructuring and functional evaluation.
- **[shineup.md](shineup.md)**: Design notes and implementation details for upgrading the `SystemsEthology` continuous interactive graphical interface.
- **[triangle.md](triangle.md)**: Technical overview of the tridiagonal coordinate system, substrate connectivity, and triangular grid reconstruction logic.
- **[watershed.md](watershed.md)**: Details the spatial projection of simulation grids onto HUC12 watershed boundaries and geographic features.
