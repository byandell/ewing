...
The **`IsleRoyaleApp()`** application provides an interactive 100% offline platform for exploring spatial wolf-moose predator-prey dynamics across the Isle Royale National Park landscape.
